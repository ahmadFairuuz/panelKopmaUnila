...
class Humas extends BaseController
{
    ...
    public function save_edited_alumni()
    {
        ...
        if (!$this->validate($validation)) {
            return redirect()->to('/humas/edit_alumni/' . $input['slug_alumni'])->withInput();
        }
        ...
        session()->setFlashdata('success', 'Data alumni berhasil diedit');
        return redirect()->to('/humas/alumni');
    }
    ...
    {
        $alumni = $this->alumniModel->asArray()->findAll();
