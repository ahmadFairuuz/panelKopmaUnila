                    ...
                    <div class="card-body my-3">
                        ...
                        <form action="<?= base_url('administrasi/save_surat_masuk') ?>" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row m-3 w-75">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" name="asal_surat" class="form-control <?= ($validation->hasError('asal_surat') ? 'is-invalid' : '') ?>" id=" asal_surat" placeholder="Asal Surat" value="<?= old('asal_surat') ?>">
                                    <div class="invalid-feedback">
