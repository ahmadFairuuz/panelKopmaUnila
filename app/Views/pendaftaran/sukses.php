                ...
                <div class="col-12">
                    ...
                    <div class="row justify-content-center">
                        <div class="col-sm-7 text-center mt-3">
                            <p>Terima kasih telah mendaftar menjadi calon anggota Koperasi Mahasiswa Universitas Lampung Selanjutnya silahkan hubungi nomor tertera</p>
                        </div>
                    </div>
                    <div class="row justify-content-center">
                        <div class="col-sm-7 text-center">
                            <!-- Ganti Link di href ini sesuai dengan link grup setiap periodenya -->
                            <a href="https://wa.me/62895610051104">
