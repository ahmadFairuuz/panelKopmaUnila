                    ...
                    <div class="card-body">
                        ...
                        <form action="<?= base_url('keuangan/save_simpanan') ?>" method="POST">
                            ...
                            <div class="row m-3 w-75">
                                ...
                                <div class="col-sm-8 w-50">
                                    <input type="text" name="nama_lengkap" class="form-control-plaintext" id="nama_lengkap" value="<?= $nama_lengkap ?>" readonly>
                                </div>
                            </div>
                            <div class="row m-3 w-75">
                            ...
                            <div class="row m-3 w-75">
                                <label for="nominal" class="col-sm-4 form-label">Nominal Denda</label>
                                <div class="col-sm-8 input-group w-50">
                                    <span class="input-group-text">Rp</span>
                                    <input type="text" name="denda" class="form-control" id="denda" placeholder="0" autofocus>
                                </div>
                            </div>
