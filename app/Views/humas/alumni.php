                            ...
                            <div class="col d-flex justify-content-between">
                                ...
                                <div class="col d-flex align-items-center">
                                    ...
                                    <!-- <form class="form w-25 ms-auto d-flex align-items-center" method="POST"
                                        ...
                                        <input name="search" type="search" class="form-control d-flex rounded-pill ms-1"
                                            style="height: 28px;" placeholder="Search" aria-label="Search"
                                            id="fieldSearch" autocomplete="off">
                                    </form> -->
                                </div>
                            </div>
                        </div>
