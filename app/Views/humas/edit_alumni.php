                    ...
                    <div class="card-body my-3">
                        ...
                        <form action="<?= base_url('humas/save_edited_alumni') ?>" method="POST">
                            ...
                            <div class="row m-3 w-75">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" name="jurusan" id="jurusan" placeholder="Jurusan" class="form-control <?= ($validation->hasError('jurusan') ? 'is-invalid' : '') ?>" value="<?= old('jurusan') != null ? old('jurusan') : $alumni->jurusan ?>">
                                    <div class="invalid-feedback">
                            ...
                            <div class="row m-3 w-75">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" name="fakultas" id="fakultas" placeholder="Fakultas" class="form-control <?= ($validation->hasError('fakultas') ? 'is-invalid' : '') ?>" value="<?= old('fakultas') != null ? old('fakultas') : $alumni->fakultas ?>">
                                    <div class="invalid-feedback">
                            ...
                            <div class="row m-3 w-75">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" name="jabatan" id="jabatan" placeholder="Jabatan di kepengurusan" class="form-control <?= ($validation->hasError('jabatan') ? 'is-invalid' : '') ?>" value="<?= old('jabatan') != null ? old('jabatan') : $alumni->jabatan ?>">
                                    <div class="invalid-feedback">
