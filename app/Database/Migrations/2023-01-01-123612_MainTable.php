...
class MainTable extends Migration
{
    public function up()
    {
        ...
        $this->forge->createTable('data_anggota', true);
        ...
        $this->forge->createTable('data_simpanan', true);
        ...
        $this->forge->addPrimaryKey('nomor_anggota');
        $this->forge->addForeignKey('nomor_anggota', 'data_anggota', 'nomor_anggota', 'CASCADE', 'CASCADE');
        $this->forge->createTable('data_poin', true);
        ...
        $this->forge->addForeignKey('nomor_anggota', 'data_anggota', 'nomor_anggota', 'CASCADE', 'CASCADE');
        $this->forge->createTable('referal', true);
        ...
        $this->forge->createTable('calon_anggota', true);
        ...
        $this->forge->createTable('data_kegiatan', true);
        ...
        $this->forge->createTable('hasil_survey', true);
        ...
        $this->forge->addForeignKey('nomor_anggota', 'data_anggota', 'nomor_anggota', 'CASCADE', 'CASCADE');
        $this->forge->createTable('pembayaran_simwa', true);
